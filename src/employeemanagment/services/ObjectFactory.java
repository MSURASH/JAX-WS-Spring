 ...
 * generated in the employeemanagment.services package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetEmployeeById_QNAME = new QName("http://services.employeemanagment/", "getEmployeeById");
    private final static QName _GetEmployeeByIdResponse_QNAME = new QName("http://services.employeemanagment/", "getEmployeeByIdResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: employeemanagment.services
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.employeemanagment/", name = "getEmployeeById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.employeemanagment/", name = "getEmployeeByIdResponse")
